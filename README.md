This is a MongoDB dashboard. To install it, you can clone the project. Make sure you have node.js installed locally, then type node server.js to start the server
